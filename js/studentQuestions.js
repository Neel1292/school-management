...
var displayData = document.querySelector(".questions-table-body");
const questionViewForm = document.querySelector(".questions-data-view");
const questionTableView = document.querySelector(".questions-table-container");
const searchQuestion = document.querySelector("#questions-search");
var allAnswers = document.querySelectorAll(".all-answers");
...
if (submit) {
    submit.addEventListener('click', () => {
        ...
        let allAnswers = document.querySelectorAll(".all-answers");
