...
const teacherNavLinks = document.querySelectorAll('nav a') as NodeListOf<HTMLAnchorElement>;
const teacherContentDivs = document.querySelectorAll('.content div') as NodeListOf<HTMLDivElement>;
